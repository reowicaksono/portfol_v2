...
const AboutView = () => {
  ...
  const tech = [
    ...
    { id: 4, name: 'JavaScript', imageUrl: 'https://cdn.icon-icons.com/icons2/2415/PNG/512/javascript_original_logo_icon_146455.png', status: 'Advanced' },
    { id: 5, name: 'Laravel', imageUrl: 'https://cdn.worldvectorlogo.com/logos/laravel-2.svg', status: 'Advanced' },
    { id: 6, name: 'CodeIgniter', imageUrl: 'https://cdn-peanutsquare.b-cdn.net/wp-content/uploads/2022/11/codeigniter-logo.png', status: 'Intermediate' },
    { id: 7, name: 'VueJS', imageUrl: 'https://cdn.iconscout.com/icon/free/png-256/free-vue-282497.png?f=webp', status: 'Intermediate' },
    { id: 8, name: 'AlpineJS', imageUrl: 'https://avatars.githubusercontent.com/u/59030169?s=200&v=4', status: 'Beginner' },
    { id: 9, name: 'NodeJS', imageUrl: 'https://cdn.iconscout.com/icon/free/png-256/free-node-js-1174925.png', status: 'Beginner' },
    { id: 10, name: 'Tailwind', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/d/d5/Tailwind_CSS_Logo.svg', status: 'Advanced' },
